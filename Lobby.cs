...
namespace Fantasy_Kingdoms_Battle
{
    ...
    internal sealed class Lobby
    {
        ...
        public Lobby(TypeLobby tl)
        {
            ...
            Lairs = new List<TypeConstruction>[TypeLobby.LairsLayers];
            GenerateConfigLairs();
            ...
            void GenerateConfigLairs()
            {
                ...
                {
                    Lairs[layer] = new List<TypeConstruction>();
                    ...
                    if (restLairs > 0)
                    {
                        List<TypeConstruction> listTypeLairs = new List<TypeConstruction>();
                        int q;
        ...
        internal List<TypeConstruction>[] Lairs { get; }
