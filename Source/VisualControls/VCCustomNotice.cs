...
namespace Fantasy_Kingdoms_Battle
{
    internal class VCCustomNotice : VisualControl
    {
        ...
        public VCCustomNotice(int width) : base()
        {
            ...
            lblCaption = new VCLabel(this, Cell.NextLeft(), 4, Program.formMain.fontMedCaptionC, Color.White, 16, "");

            lblText = new VCLabel(this, lblCaption.ShiftX, 27, Program.formMain.fontMedCaptionC, Color.White, 16, "");
            Height = 54;
            Width = width;
