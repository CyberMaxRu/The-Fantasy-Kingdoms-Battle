...
namespace Fantasy_Kingdoms_Battle
{
    internal sealed class WindowPlayerPreferences : VCForm
    {
        ...
        public WindowPlayerPreferences(Lobby lobby) : base()
        {
            ...
            editName = new VCEdit(ClientControl, 0, 0, "", FormMain.Config.MaxLengthNameEntity);
            editName.Width = 240;
        ...
        {
            WindowConfirm.ShowConfirm("Подтверждение", "Удалить аватар?", DeleteAvatar);
        }

        private void DeleteAvatar(object sender, EventArgs e)
        {
        ...
        private void UpdateNumberAvatar()
        {
            ...
            imgAvatar.TextCaption.Text = $"{curImageIndexAvatar - FormMain.Config.ImageIndexFirstAvatar + 1}/{FormMain.Config.QuantityAllAvatars}";
