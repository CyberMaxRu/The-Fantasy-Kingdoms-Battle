...
namespace Fantasy_Kingdoms_Battle
{
    internal sealed class WindowSetupTournament : WindowOkCancel
    {
        ...
        public WindowSetupTournament(LobbySettings ls) : base("Настройка Войны лордов")
        {
            ...
            VCLabel lblGold = new VCLabel(panelSettings, FormMain.Config.GridSize, btnLocation.NextTop(), Program.formMain.FontSmall, Color.White, 16, $"Золота на старте: {ls.TypeLobby.Gold}");
