...
namespace Fantasy_Kingdoms_Battle
{
    ...
    internal sealed class CellMenuConstructionResearch : CellMenuConstruction
    {
        ...
        internal override void PrepareHint(PanelHint panelHint)
        {
            ...
            panelHint.AddStep12CostExecuting(PurchaseValue);
        }
    ...
    internal sealed class CellMenuConstructionBuild : CellMenuConstruction
    {
        ...
        internal override void PrepareHint(PanelHint panelHint)
        {
            ...
            panelHint.AddStep12CostExecuting(TypeConstruction.Levels[1].GetCreating().CostResources);
    ...
    internal sealed class CellMenuConstructionLevelUp : CellMenuConstruction
    {
        ...
        internal override void PrepareHint(PanelHint panelHint)
        {
            ...
            panelHint.AddStep12CostExecuting(Descriptor.GetCreating().CostResources, Descriptor.GetCreating().CalcConstructionPoints(Construction.Player), ExecutingAction.RestDaysExecuting, GetTextRequirements());
